...
// Import Style
import styles from './BookmarkCreateWidget.css';

export class BookmarkCreateWidget extends Component {
  addPost = () => {
...
BookmarkCreateWidget.propTypes = {
  addPost: PropTypes.func.isRequired,
  showAddPost: PropTypes.bool.isRequired,
  intl: intlShape.isRequired,
};

export default injectIntl(BookmarkCreateWidget);
